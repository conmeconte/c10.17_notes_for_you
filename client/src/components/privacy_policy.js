...
export default ()=>{
    return(
        <div className="container">
            ...
            <h3>FlexNotes Privacy Policy</h3>
            <h4>Privacy Policy</h4>
            <p>Last updated: 02/07/2018</p>
            <p>My Company FlexNotes ("us", "we", or "our") operates https://www.flexnotes.net (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
            ...
            <p>This Privacy Policy is effective as of 02/07/2018 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
